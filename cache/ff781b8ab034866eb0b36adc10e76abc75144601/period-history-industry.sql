...
FROM (
  ...
  'period'::text ||'-::-parentAuthor' as key
...
SELECT
  ...
  'history'::text ||'-::-parentAuthor' as key
...
SELECT
  ...
  'industry'::text ||'-::-parentAuthor' as key
